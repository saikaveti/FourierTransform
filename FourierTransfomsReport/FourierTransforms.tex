...
\begin{subfigure}{.4\textwidth}
	\centering
	\includegraphics[scale=.25]{images/FFTOriginal2.png}
	\caption{Real Space}
	\label{fig:sub3}
\end{subfigure} %
\begin{subfigure}{.4\textwidth}
	\centering
	\includegraphics[scale=.25]{images/FFTResult2.png}
	\caption{Frequency Space}
	\label{fig:sub4}
\end{subfigure}
...
\bibitem{Bracewell} Bracewell, R. N. (2000) \emph{The Fourier Transform and its Applications} McGraw-Hill Higher Education
...
\bibitem{Dym} Dym, H \& McKean, H. P. (1972) \emph{Fourier Series and Integrals} Probability and Mathematical Statististics No. 14, New York and London, Academic Press
